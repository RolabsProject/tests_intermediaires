...
def callback(mesg_list, time):
    ...
    """
    avance = '\xAC\x00\x04\x40\x44'
    recule = '\xA8\x00\x7C\x40\x3C'
    stop = '\xAC\x00\x00\x40\x40'
    gauche = '\xA4\x7C\x00\x40\x3C'
    droite = '\xAC\x04\x00\x40\x44'
    global ser
    ...
    for mesg in mesg_list:
		...
		print "A"
		ser.write(miseEnForme.miseEnForme(0,0,0))
		...
		print "UP"
		ser.write(miseEnForme.miseEnForme(0,10,0))

            elif mesg[1] == 0x100:  # Left botton
		print "LEFT"
		ser.write(miseEnForme.miseEnForme(-10,0,0))
